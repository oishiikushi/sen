...
/**
 * This class provides an empty implementation of {@link PlayFieldListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
public class PlayFieldBaseListener implements PlayFieldListener {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void exitValue(PlayFieldParser.ValueContext ctx) { }
